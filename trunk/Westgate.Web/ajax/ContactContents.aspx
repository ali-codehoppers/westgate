<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Blank.Master" AutoEventWireup="true"
    CodeBehind="ContactContents.aspx.cs" Inherits="Westgate.Web.ajax.ContactContents" %>
        ...
        <div style="float: left; width: 35%;">
            ...
            <%--<div style="color: #faa01d; font-weight: bold; font-size: 10pt; margin-top: 30px;
                margin-bottom: 20px; min-height:330px">
                 <div style="color:
        #faa01d; font-weight: bold; font-size: 10pt; margin-top: 30px; margin-bottom: 20px;">
        West Gate Maintenance Ltd 
            </div>--%>
            <%--  <div style="color: #4f5456; font-weight: bold;">
                <%-- Grenville Workshops<br /> 502 Hornsey Road<br /> LONDON<br /> N19 4EF<br />
        <br /> <br /> <span style="color: #faa01d;">T:</span> +44 (0) 207 281 4291<br />
        <span style="color: #faa01d;">F:</span> +44 (0) 207 272 0211<br /> <span style="color:
        #faa01d;">E:</span> <a href="mailto:annette@west-gate.net">annette@west-gate.net</a>
