...
<asp:GridView ID="gvImages" runat="server" BackColor="White" BorderColor="#DEDFDE" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Before Image" 
            ...
            <ItemTemplate>
                <asp:Image Width="32" Height="19" ImageUrl='<%# GetThumbnailImagePath(Eval("BeforeImagePath")) %>' runat="server"/> 
        ...
        <asp:TemplateField HeaderText="After Image" SortExpression="AfterImagePath">
            ...
            <ItemTemplate>
                <asp:Image Width="32" Height="19" ImageUrl='<%# GetThumbnailImagePath(Eval("AfterImagePath")) %>' runat="server"/>  
        ...
        <asp:TemplateField HeaderText="Combined Image" 
            ...
            <ItemTemplate>
                ...
                <asp:Image Width="64" Height="19" ImageUrl='<%# GetThumbnailImagePath(Eval("CombinedImagePath")) %>' runat="server"/>  
